...
void remodelRefactor(int handPos, int currentPlayer, struct gameState* state, int choice1, int choice2){
...
void cutpurseRefactored(int currentPlayer, struct gameState* state, int handPos){
...
void ambassadorRefactored(int choice1, int choice2, int handPos, struct gameState* state, int currentPlayer){
...
void minionRefactored(struct gameState* state, int handPos, int currentPlayer, int choice1, int choice2){
...
void stewardRefactored(int choice1, int choice2, int choice3, int currentPlayer, struct gameState* state, int handPos) {
...
int mineRefactored(int handPos, int choice1, int choice2, struct gameState *state, int currentPlayer) {
...
void salvagerRefactored(struct gameState* state, int choice1, int currentPlayer, int handPos){
...
void seaHagRefactored(struct gameState *state, int currentPlayer) {
        int i;
        for (i = 0; i < state->numPlayers; i++){
                if (i != currentPlayer){
...
void greatHallRefactored(int currentPlayer, struct gameState *state, int handPos) {
        //+1 Card
      drawCard(currentPlayer, state);
...
void outpostRefactored(struct gameState *state, int handPos, int currentPlayer) {
    //set outpost flag
  state->outpostPlayed++;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case mine:
      ...
      mineRefactored(handPos, choice1, choice2, state, currentPlayer);			
      return 0;
			
    case remodel:
      remodelRefactor(handPos, currentPlayer, state, choice1, choice2);
      return 0;
    ...
    case great_hall:
      ...
      greatHallRefactored(currentPlayer, state, handPos);
      return 0;
		
    case minion:
            minionRefactored(state, handPos, currentPlayer, choice1, choice2);
            return 0;
		
    case steward:

      stewardRefactored(choice1, choice2, choice3, currentPlayer, state, handPos);
      return 0;
    ...
    case ambassador:
      ambassadorRefactored(choice1, choice2, handPos, state, currentPlayer);
      return 0;
		
    case cutpurse:
      cutpurseRefactored(currentPlayer, state, handPos);
      return 0;
    ...
    case outpost:
      ...
      outpostRefactored(state, handPos, currentPlayer);
      return 0;
		
    case salvager:
            salvagerRefactored(state, choice1, currentPlayer, handPos);
      return 0;
		
    case sea_hag:

      seaHagRefactored(state, currentPlayer);
      return 0;
